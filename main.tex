...
Then we show some limitation of the fully-probabilistic approach, proving it is too fine-graned for the quantum case. Thus, we derive an updated versione of bisimilarity that solves this issue while maintaining the previous properties. Finally, we compare our proposal with related works.
